...
class Models:
    ...
    MINIMAX_MINIMAX_M2_5 = BedrockModel("minimax.minimax-m2.5")
    MISTRAL_DEVSTRAL_2_123B = BedrockModel("mistral.devstral-2-123b")
    ...
    NVIDIA_NEMOTRON_SUPER_3_120B = BedrockModel("nvidia.nemotron-super-3-120b")
    ...
    AMAZON_NOVA_SONIC = _DeprecatedModelDescriptor("amazon.nova-sonic-v1:0", "Model 'amazon.nova-sonic-v1:0' has LEGACY status and may be removed by AWS. Consider migrating to a newer model.")
    AMAZON_TITAN_IMAGE_GENERATOR = _DeprecatedModelDescriptor("amazon.titan-image-generator-v2:0", "Model 'amazon.titan-image-generator-v2:0' has LEGACY status and may be removed by AWS. Consider migrating to a newer model.")
    ANTHROPIC_CLAUDE_3_5_HAIKU_20241022 = _DeprecatedModelDescriptor("anthropic.claude-3-5-haiku-20241022-v1:0", "Model 'anthropic.claude-3-5-haiku-20241022-v1:0' has LEGACY status and may be removed by AWS. Consider migrating to a newer model.")
